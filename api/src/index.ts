...
import { sotaRoutes } from './routes/sota';
import { dmrIdRoutes } from './routes/dmrid';
...
import { clublogRoutes } from './routes/clublog';
...
app.route('/api/sota', sotaRoutes);
app.route('/api/dmrid', dmrIdRoutes);
...
app.route('/api/clublog', clublogRoutes);
